...
project = u'Fault Analyzer'
copyright = u'2019, ANSSI'
author = u'Thomas Trouchkine'
...
extensions = ['sphinx.ext.todo', 'sphinx.ext.viewcode', 'sphinx.ext.autodoc', 'sphinx.ext.imgmath','sphinx_rtd_theme']
